...
describe('Cypress commands for locating elements', () => {
    it('1- primary get command', () => {
    ...
    it("8- Filter and not command", () => {
        cy.visit("https://play2.automationcamp.ir/index.html")
        cy.get("td").filter("#td_id")
        cy.get("td").not("#td_id")
    })
    it("9- Traversal commands", () => {
        cy.visit("https://play2.automationcamp.ir/index.html")
